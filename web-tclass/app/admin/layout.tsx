          ...
          {mainNavItems.map((item) => {
            ...
            return (
              <Link 
                ...
                href={item.href} 
                className={isActive 
                  ? "flex items-center justify-between px-4 py-2 bg-[#1E5EFF] text-white rounded-[10px] text-[12px] font-bold shadow-[0_4px_12px_rgba(30,94,255,0.2)]"
                  : "flex items-center justify-between px-4 py-2 text-slate-300 hover:bg-white/5 hover:text-white rounded-[10px] text-[12px] font-semibold transition-colors group"
                }
              >
